...
# Checks if the user input is a string
def str_checker(question, error):
    valid = False
    while not valid:
...
def instructions():
    ...
    print("1. Enter your basic facts choice by typing its number\n"
          ...
          "5. Press <enter> to play again or type 'xxx' to quit\n")
...
str_error = "Please try again. Type your name using the alphabet.\n"
...
print("*** Basic Facts Type Options ***\n")
